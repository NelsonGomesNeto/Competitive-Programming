...
struct Data
{
  ...
  {
    int l = min(lo, other.lo), r = max(hi, other.hi);
    int cnt = cntInRange(value, l, r);
    int otherCnt = cntInRange(other.value, l, r);
    if (cnt > otherCnt) return Data{value, l, r};
    return Data{other.value, l, r};
  }
};
const Data nil = Data{-1, maxN - 1, 0};
